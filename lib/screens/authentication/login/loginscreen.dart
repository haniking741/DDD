          ...
          CustomTextField(
           ...
           SizedBox(height: 16.h),
                      ...
                      Row(
                        ...
                        children: [
                          PrimaryTextButton(text: localeProvider.translate('forgot_pass'), onPressed: (){
                            Navigator.of(context).push(
  PageRouteBuilder(
    transitionDuration: Duration(milliseconds: 500),
    pageBuilder: (context, animation, secondaryAnimation) => ForgotPassEmail(),
    transitionsBuilder: (context, animation, secondaryAnimation, child) {
      return SlideTransition(
        ...
        child: child,
                      ...
                      SizedBox(height: 16.h),
                          PrimaryButton(text: localeProvider.translate('Login_button'), onPressed: (){
  ...
  (route) => false,
      ...
      Container(
        ...
        decoration: BoxDecoration(
          ...
          border: Border.all(color: TColors.labeltext.withOpacity(0.3)),
      ...
      SizedBox(height: 20.h,),
      Already_have_account(context: context, text:localeProvider.translate('already'), button_text:localeProvider.translate('signup_button') , onPressed: (){Navigator.of(context).pushAndRemoveUntil(
  PageRouteBuilder(
    transitionDuration: Duration(milliseconds: 400),
