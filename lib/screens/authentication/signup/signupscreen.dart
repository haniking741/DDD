...
class _SignupScreenState extends State<SignupScreen> {
    ...
    return WillPopScope(
      ...
      children: [
        ...
        CustomTextField(
          ...
          validator: (value) =>
              MyValidators.displayNameValidator(context, value),
          ...
          onPressed: () {
            ...
            if (!isChecked) {
              ScaffoldMessenger.of(context).showSnackBar(
                SnackBar(
                  content: Text(
                    localeProvider.translate('error_accept_terms'),
                  ),
  ...
  debugPrint("✅ Navigating to Verification");

Navigator.of(context).push(
  PageRouteBuilder(
    transitionDuration: Duration(milliseconds: 500),
    pageBuilder: (context, animation, secondaryAnimation) =>
        Verification(email: emailController.text.trim()),
    transitionsBuilder: (context, animation, secondaryAnimation, child) {
      ...
      SizedBox(height: 20.h,),
      Already_have_account(context: context, text:localeProvider.translate('already_account'), button_text:localeProvider.translate('Login_button') , onPressed: (){ 
