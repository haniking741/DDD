  ...
  final List<Map<String, dynamic>> products = [
    {
      ...
      "rating": 4.5,
      "description":
          "emergency hospital Alia Salah for operations & Medical follow-up",
    },
    {
      "main_image": "assets/images/hospitals/hospital1.jpg",
      "second_image": "assets/images/hospitals/hospital2.jpeg",
      ...
      "rating": 4.3,
      "description":
          "Ennour Clinic provides specialized medical care in surgery, gynecology, pediatrics, and internal medicine in Tebessa.",
    },
  ];
              ...
              if (selectedCategory == "Others") {
                ...
                Navigator.push(
                  ...
                  PageRouteBuilder(
                    ...
                    pageBuilder:
                        (context, animation, secondaryAnimation) =>
                            DoctorsFetch(category: selectedCategory),
                    transitionsBuilder: (
                      context,
                      animation,
                      secondaryAnimation,
